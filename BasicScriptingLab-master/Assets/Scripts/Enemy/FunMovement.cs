...
public class FunMovement : EnemyMovement
{
    ...
    void Update()
    {
        ...
        transform.position = Vector2.MoveTowards(transform.position, target.transform.position, timer / respawnTimer * speed * Time.deltaTime);
    }
